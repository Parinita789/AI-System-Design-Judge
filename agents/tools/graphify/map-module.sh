...
#
# Usage:
#   agents/tools/graphify/map-module.sh <module-name> [graphify-extract-flags...]
#
# Examples:
#   agents/tools/graphify/map-module.sh build-sessions
#   agents/tools/graphify/map-module.sh evaluations --max-concurrency 1
#   MODEL=claude-sonnet-4-6 agents/tools/graphify/map-module.sh llm
#
# Three things happen in order:
#   1. `graphify extract` against backend/src/<resolved-path> →
#      writes raw symbol-level graph to
#      agents/data/knowledge-graphs/<name>/graphify-out/
...
OUT_DIR="$REPO_ROOT/agents/data/knowledge-graphs/$MODULE"
