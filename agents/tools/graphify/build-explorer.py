...
Output:
  agents/data/knowledge-graphs/<package>-module-level/MODULE_EXPLORER.html

Usage:
  agents/tools/graphify/build-explorer.py backend
  agents/tools/graphify/build-explorer.py backend --include-infra
"""
...
def main() -> None:
    ...
    out_path = REPO_ROOT / 'agents' / 'data' / 'knowledge-graphs' / f'{args.package}-module-level' / 'MODULE_EXPLORER.html'
