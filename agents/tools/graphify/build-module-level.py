...
Usage:
  agents/tools/graphify/build-module-level.py <mapper-json> <out-dir>
    e.g. agents/tools/graphify/build-module-level.py \\
            agents/data/codebase-map/backend.json \\
            agents/data/knowledge-graphs/backend-module-level
"""
...
# of the agents/data/knowledge-graphs/ outputs.
STYLE_OVERRIDE = """
    <style>
...
def main() -> None:
    ...
    parser.add_argument(
        'mapper_json',
        type=Path,
        help='Path to mapper output (e.g. agents/data/codebase-map/backend.json)',
    )
    parser.add_argument(
        'out_dir',
        type=Path,
