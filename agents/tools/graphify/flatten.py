...
Usage:
  agents/tools/graphify/flatten.py <out-dir>
    e.g.   agents/tools/graphify/flatten.py agents/data/knowledge-graphs/llm

  agents/tools/graphify/flatten.py <out-dir> --include-tests
...
def main() -> None:
    ...
    parser.add_argument(
        'out_dir',
        type=Path,
        help='Directory containing graphify-out/ (e.g. agents/data/knowledge-graphs/llm)',
    )
    parser.add_argument(
        '--include-tests',
        action='store_true',
