...
attributes. Outputs:
  ...
  agents/data/schema/SCHEMA_DIAGRAM.html    Mermaid erDiagram + meta
  agents/data/schema/schema.md              source markdown (mermaid block)

Usage:
  agents/tools/build-schema-diagram.py
"""
...
<body>
  ...
  <div class="meta">
    ...
    Generated by <code>agents/tools/build-schema-diagram.py</code>
  </div>
...
def main() -> None:
    ...
    out_dir = REPO_ROOT / 'agents' / 'data' / 'schema'
    ...
    print(f'wrote agents/data/schema/SCHEMA_DIAGRAM.html ({len(models)} models, {len(relations)} relations)')
    print(f'wrote agents/data/schema/schema.md')
