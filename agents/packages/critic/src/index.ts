...
const DEFAULT_OUTPUT = './agents/data/critic-out';
...
async function main(): Promise<void> {
  ...
  program
    ...
    .option('-l, --lens <name>', 'persona name (resolves to agents/packages/critic/personas/<name>.md)', 'staff-engineer')
    ...
    .option('--rubric <path>', 'override the rubric path (default agents/packages/critic/rubric.md)')
