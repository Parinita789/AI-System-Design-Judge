...
Output:
  agents/architecture/ARCHITECTURE.html
  agents/architecture/architecture.md   (mermaid source for PRs)
"""
...
OUT_DIR = REPO_ROOT / 'agents' / 'architecture'
...
<body>
  ...
  <div class="meta">
    ...
    <code>agents/build-architecture.py</code> to change.
  </div>
...
def main() -> None:
    ...
    print('wrote agents/architecture/ARCHITECTURE.html')
    print('wrote agents/architecture/architecture.md')
