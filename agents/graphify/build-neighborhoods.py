...
The output lives at:
  agents/graphify/<module>/MODULE_NEIGHBORHOOD.md
  agents/graphify/<module>/MODULE_NEIGHBORHOOD.html

This is the "what does THIS module touch" view, complementing
build-mermaid.py's "show everything" diagram.

Usage:
  agents/graphify/build-neighborhoods.py <package>
  agents/graphify/build-neighborhoods.py <package> --module evaluations
  agents/graphify/build-neighborhoods.py backend --include-infra
"""
...
def build_md(mermaid: str, stats: dict, package: str) -> str:
    ...
    out.append(
        ...
        f'Generated from `agents/codebase-map/{package}.json`.'
    )
    out.append('')
...
def main() -> None:
    ...
    for mid in targets:
        ...
        out_dir = REPO_ROOT / 'agents' / 'graphify' / mid
